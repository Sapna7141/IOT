...
#define WIFISSID "redmi" // Enter WifiSSID here
#define PASSWORD "sapna_sharma" // Enter password here
#define TOKEN "BBFF-ERQZav0K78O9fGm8ghJTpE8eIRBzBG" // Ubidots' TOKEN
