...
long channelId = 1745964; // channel id

//experimenatl
char userName[] = "FTcwLjsUAx8cJSAaHwQYJTA"; // anything you want
char passKey[] = "8XwePzwt6yAI90EGwetrCUuw"; // profile key or user api key
char clientId[] = "FTcwLjsUAx8cJSAaHwQYJTA";
